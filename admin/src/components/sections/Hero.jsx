...
const container = {
  ...
  visible: {
    ...
    transition: {
      ...
      delayChildren: 7, // robot on screen 7s, then text slides in as robot fades
    },
  },
};

const ROBOT_FADE_DELAY = 7000; // robot on screen 7s, then slowly fades as text slides in
    ...
    <section className="relative min-h-[90vh] overflow-hidden bg-[var(--background)] px-4 pt-20 pb-24 md:min-h-[88vh] md:pt-28 md:pb-30">
      ...
      <div className="relative z-10 mx-auto grid max-w-6xl gap-12 pt-4 md:grid-cols-[1fr,360px] md:gap-16 md:items-start md:pt-8">
        ...
        <motion.div
          ...
          transition={{ duration: 0.85, delay: 7.2, ease: [0.25, 0.4, 0.25, 1] }}
