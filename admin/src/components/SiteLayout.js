...
export default function SiteLayout({ children, siteName = 'Client' }) {
  ...
  const navItems = [
    ...
    { href: `/dashboard/sites/${id}/customers`, label: 'Customers', icon: '👤' },
    { href: `/dashboard/sites/${id}/jobs`, label: 'Jobs', icon: '📌' },
    { href: `/dashboard/sites/${id}/dispatch`, label: 'Dispatch', icon: '📅' },
    { href: `/dashboard/sites/${id}/technicians`, label: 'Technicians', icon: '🔧' },
    { href: `/dashboard/sites/${id}/invoices`, label: 'Invoices', icon: '📄' },
    { href: `/dashboard/sites/${id}/payments`, label: 'Payments', icon: '💵' },
    { href: `/dashboard/sites/${id}/pipeline`, label: 'Pipeline', icon: '📊' },
